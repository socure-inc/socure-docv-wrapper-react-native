require "json"
package = JSON.parse(File.read(File.join(__dir__, "package-dr.json")))
Pod::Spec.new do |s|
  s.name         = "rn-socure-sdk-device-risk"
  ...
  s.dependency 'DeviceRisk'
  s.dependency 'SocureSdkWithDeviceRisk'
